...
public class MyAdopterForDemandPendingForHOApproval extends
        FirebaseRecyclerAdapter<ModelClientSiteWorkTypeItemSubItemQuantityMaster,
                MyAdopterForDemandPendingForHOApproval.myViewHolder> {
     ...
     * @param options
     */
    public MyAdopterForDemandPendingForHOApproval(@NonNull FirebaseRecyclerOptions<ModelClientSiteWorkTypeItemSubItemQuantityMaster> options) {
        super(options);
    }
